...
️**Title**: `Survive!! This is our title.`

**Purpose**: `The player tries to survive the longest and get points, if they die the score will be posted in a schoreboard and then the game can be played again.`

️**Source Assignment(s)**: `Whisker and Tacocat.`
...
```
    Branch 1 starting name: htook_branch
    Branch 2 starting name: Escobedo_branch
```
